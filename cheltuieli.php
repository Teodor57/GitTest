...
<head>
	<title>Contact</title>
	<link rel="stylesheet" type="text/css" href="style_cheltuieli.css">
	<meta name="viewport" content="width=device-width, initial-scale=1">
</head>
<body>
    <?php 
		include 'logger.php'; 
		$log="Spendings page visited.";
		logger($log);
	?>
...
<ul>
  ...
  <li><a class="active" href="cheltuieli.php">Cheltuieli</a></li>
